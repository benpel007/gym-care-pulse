...
-- Create the gym_profiles table if it doesn't exist
...
-- Update staff_members RLS policies to properly reference gym_profiles
DROP POLICY IF EXISTS "Gym owners can view their staff" ON public.staff_members;
DROP POLICY IF EXISTS "Gym owners can add staff" ON public.staff_members;
DROP POLICY IF EXISTS "Gym owners can update their staff" ON public.staff_members;
DROP POLICY IF EXISTS "Gym owners can delete their staff" ON public.staff_members;
